...
# bash -x debug.sh => to see the debug vars values in execution
# bash -x -v debug.sh => to see the debug vars values in execution and the commands executed

# set degub
# set -x
# ... code => to debug a specific code
# set +x
